...
python inference_profiling.py --config ${MODELS_DIR}/tests_simpler_rechits/run_41_datasetv10_verysmall_nconv2_morepatience_lessL2/training_config.json  \
       --weights_name weights.best.hdf5 \
       --log_folder tensorflow_logs_fixedpadding_cl15_r20/ \
       --conf-overwrite validation_config_v10_cl15_r20.json
...
python inference_profiling.py --config ${MODELS_DIR}/tests/run_32_standard_datasetv10/training_config.json \
       --weights_name weights.best.hdf5 \
       --log_folder tensorflow_z1logs_fixedpadding_cl60_r60/ \
       --conf-overwrite validation_config_v10_cl60_r60.json

python inference_profiling.py --config ${MODELS_DIR}/tests_norechits/run_20_datasetv10_small_l2small/training_config.json \
       --weights_name weights.best.hdf5 \
       --log_folder tensorflow_logs_fixedpadding_cl60_r60/  \
       --conf-overwrite validation_config_v10_norechits_cl60_r60.json
