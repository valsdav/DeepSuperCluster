...
python submit_validation_condor.py --model-config ${MODELS_DIR}/tests_norechits/run_24_datasetv10_supersmall_nconv2/training_config.json \
       --model-weights weights.best.hdf5 \
       -o  ${MODELS_DIR}/tests_norechits/run_24_datasetv10_supersmall_nconv2/validation_data \
        --conf-overwrite validation_config_v10_norechits.json 
