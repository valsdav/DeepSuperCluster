...
for eta_interval in args.eta_intervals:
    ...
    for enbin in range(len(ens)-1):
        ...
        ax1.plot(x, y_calo/y_must, "b",label="median - calomatched - DeepSC / Mustache")
        ...
        ax2.plot(x, y_calo/y_must,  "b", label="68% width - Deep SC / Mustache",)
        ...
        fig.savefig(args.outputdir +f"/scale_width_eta_{eta_bin[0]}-{eta_bin[1]}_et_{ens[enbin]}-{ens[enbin+1]}_seed_mustacheratio.png")
