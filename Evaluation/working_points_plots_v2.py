...
for f in glob.glob(inputdir+ "electrons/numpy_wp_ele_v{}/testing/clusters_data_*.pkl".format(args.input_version)):
    i+=1
...
i = 0
datas_gamma = []
for f in glob.glob(inputdir+ "gammas/numpy_wp_gamma_v{}/testing/clusters_data_*.pkl".format(args.input_version)):
    i+=1
    if i >ninputfiles: break
    d = pickle.load(open(f, "rb"))
