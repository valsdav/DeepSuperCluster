...
python condor_ndjson.py -i ${BASEDIR}/FourElectronsGunPt1-500_pythia8_PremixRun3_bsRealistic2022_13p6TeV_126X_mcRun3_2023_forPU65_v4_DumperTraining \
       -nfg 25  --maxnocalow 0 \
       -o /eos/user/r/rdfexp/ecal/cluster/output_deepcluster_dumper/windows_data/electrons/run3_126X_2023/ndjson_126X_mcRun3_2023_forPU65_v4\
       -a sim_fraction --wp-file simfraction_electron_run3_PU65.json \
       -q espresso -e user \
       --min-et-seed 1  --pu-limit 1e7 -c -cf condor_njdson_electron_run3_2023
...
python condor_ndjson.py -i ${BASEDIR}/FourGammasGunPt1-500_pythia8_PremixRun3_bsRealistic2022_13p6TeV_126X_mcRun3_2023_forPU65_v4_DumperTraining \
       -nfg 25  --maxnocalow 0 \
       -o /eos/user/r/rdfexp/ecal/cluster/output_deepcluster_dumper/windows_data/gammas/run3_126X_2023/ndjson_126X_mcRun3_2023_forPU65_v4\
       -a sim_fraction --wp-file simfraction_photon_run3_PU65.json \
       -q espresso -e user \
       --min-et-seed 1  --pu-limit 1e7 -c -cf condor_njdson_photon_run3_2023
