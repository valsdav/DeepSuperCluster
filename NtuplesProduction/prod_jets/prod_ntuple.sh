...
python ../condor_ndjson_jet.py -q espresso \
 ...
 -i /eos/cms/store/group/dpg_ecal/alca_ecalcalib/bmarzocc/Clustering/FourJetsGunPt1-100_EMEnriched_pythia8_StdMixing_Flat55To75_14TeV_112X_mcRun3_2021_realistic_v16_Reduced_Dumper_SLIM/hadd \
 -tf 0 --min-et-seed 1. --maxnocalow 0 -a sim_fraction --wp-file simScore_Minima_ElectronsOnly_updated.root -nfg $1 --compress
