...
transfer_input_files    = ../cluster_ndjson_jet.py, ../windows_creator_jet.py, ../calo_association.py, ../simScore_WP/{wp_file}, ../Mustache.C
...
python cluster_ndjson_jet.py -i ${INPUTFILE} -o output.ndjson \
