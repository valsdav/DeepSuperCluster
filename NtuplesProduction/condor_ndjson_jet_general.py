...
transfer_input_files    = ../cluster_ndjson_jet_general.py, ../windows_creator_dynamic_global_nooverlap_jet_general.py, ../calo_association.py, ../simScore_WP/{wp_file}, ../Mustache.C
