...
#  -tf 0 --min-et-seed 1. --maxnocalow 8 -a sim_fraction --wp-file simScore_Minima_ElectronsOnly.root -nfg $1 --compress
 ...
 -o /eos/user/r/rdfexp/ecal/cluster/output_deepcluster_dumper/windows_data/gammas/ndjson_v3 \
 ...
 -tf 0 --min-et-seed 1. --maxnocalow 10 -a sim_fraction --wp-file simScore_Minima_PhotonsOnly.root -nfg $1 --compress
