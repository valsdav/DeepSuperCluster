...
#  -tf 0 --min-et-seed 1. --maxnocalow 8 -a sim_fraction --wp-file simScore_Minima_ElectronsOnly.root -nfg $1 --compress
 ...
 -o /eos/user/r/rdfexp/ecal/cluster/output_deepcluster_dumper/windows_data/gammas/ndjson_v10 \
 -i /eos/cms/store/group/dpg_ecal/alca_ecalcalib/bmarzocc/Clustering/FourGammasGunPt1-100_pythia8_StdMixing_Flat55To75_14TeV_Reduced_Dumper_FULL/hadd/ \
 -tf 0 --min-et-seed 1. --maxnocalow 3 -a sim_fraction --wp-file simScore_Minima_PhotonsOnly_updated.root -nfg $1 --compress
