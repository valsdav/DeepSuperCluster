    ...
    def get_windows(self, event, assoc_strategy,  nocalowNmax, min_et_seed=1, debug=False):
        ...
        for icl, clenergy_T in clenergies_ordered:
            ...
            if not self.overlapping_window and is_in_window:
                ...
                if pfcluster_parton_map[icl] !=-1 and pfcluster_calo_score[icl] > self.seed_min_fraction:
                    # ID of the associated caloparticle
                    caloid = pfcluster_calo_map[icl]
                    partonid = pfcluster_parton_map[icl]
        ...
        for window in windows_map.values():
            ...
            parton_index = window["parton_index"]
